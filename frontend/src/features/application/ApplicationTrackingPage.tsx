  ...
  return (
    <div className="py-8 sm:py-12 bg-slate-50 min-h-screen">
      <Container size="md">
        ...
        {/* Status Card */}
        <Card variant="elevated" className="mb-6 bg-gradient-to-br from-white to-slate-50 border-slate-200">
        ...
        <Card variant="default" className="space-y-6 mb-8">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-brand-600" />
              <span>Immutable Commercial Contract Snapshot</span>
            </h3>
            <span className="text-xs text-slate-400">Recorded: {new Date(application.appliedAt).toLocaleDateString()}</span>
          </div>

          <div className="space-y-3">
            <div className="flex justify-between items-start text-sm">
              <div>
                <h4 className="font-bold text-slate-900">{contractSnapshot.productName}</h4>
                <p className="text-xs text-slate-500">{contractSnapshot.variantName} (SKU: {contractSnapshot.sku})</p>
              </div>
              <span className="font-extrabold text-slate-900">{formatINR(contractSnapshot.principalAmount)}</span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-2 text-xs sm:text-sm">
              <div className="flex justify-between text-slate-600">
                ...
                <span className="font-semibold text-slate-900">{contractSnapshot.providerName}</span>
              </div>
              <div className="flex justify-between text-slate-600">
                <span>Tenure Duration</span>
                <span className="font-semibold text-slate-900">{contractSnapshot.tenureMonths} Months</span>
              </div>
              <div className="flex justify-between text-slate-600">
            ...
            <div className="pt-2 flex items-center justify-between">
              ...
              <div className="text-right">
                <span className="text-xs text-slate-500 block">Total Financed Amount</span>
