...
| 11| **Security & Auth** | Protected admin endpoints, hashed passwords, safe errors | `bcryptjs` hashing, JWT stateless auth, Helmet headers, Rate limiting, centralized error handling | Secrets loaded from environment; zero unhandled stack traces returned to client |
